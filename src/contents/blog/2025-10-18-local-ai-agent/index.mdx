...
date: 2025-10-14
tags: ["生成AI", "AIエージェント", "ローカルAI", "mastra", "ollama", "LM Studio", "TypeScript"]
category: "生成AI"
...
いくつか企業や人物が主張しているように SLM (Small Language Model) を組み合わせるアーキテクチャが主流になっていくのは正しいと思う。
...
しかし、これがより高度に発展し、SLM の性能・専門性が今後上がっていくことでトークンあたりのコストがさらに抑えられていくのではなかろうか。
