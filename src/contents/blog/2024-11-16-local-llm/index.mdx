...
[Nix](https://nixos.org/) + [Home Manager](https://nix-community.github.io/home-manager/) を使って環境を管理しているため、以下の設定を普段管理している設定ファイルで `import` する。
...
日本語の LLM を試したい人は [日本語LLMまとめ | LLM-jp](https://llm-jp.github.io/awesome-japanese-llm/) で気になったモデルを試してみるのがよさそうだ。
