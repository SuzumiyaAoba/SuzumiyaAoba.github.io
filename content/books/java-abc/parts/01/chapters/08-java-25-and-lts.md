...
- **新しい機能を学べるから** ： Java 25 時点までに積み重ねられた便利な機能を学べる

実際、Java 25 は2025年9月16日に正式公開された LTS であり、長期にわたるサポートが予定されています[^jdk25-release-date]。
これから Java を学び始めるなら、長く使えて、かつモダン Java の機能まで学べる Java 25 は、最適な選択肢のひとつです。
...
- 本書が Java 25 を選ぶのは、「最新の LTS で長く使え、モダン Java の機能まで学べる」からである
