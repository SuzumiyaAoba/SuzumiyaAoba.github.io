...
<Message title="Note" variant="warning" defaultOpen>
  ...
  Unverified items are marked with{" "}
  <MdxLabel variant="warning">Unverified</MdxLabel>.
</Message>
...
<Img
  src="./images/claude-code_config.png"
  alt="Claude Code settings screen"
  width="600"
/>
...
<Img
  src="./images/claude-code_language.png"
  alt="Claude Code language settings"
  width="600"
/>

Now the default language for Claude Code is Japanese. Press <kbd>Esc</kbd> to exit the settings screen.
