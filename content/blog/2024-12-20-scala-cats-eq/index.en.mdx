...
model: GPT-5.2-Codex
description: Part of the Scala Cats type class series, explaining the Eq type class for equality and how to use it in code.
---
...
One is to use `Eq.fromUniversalEquals`, which is implemented in the official docs. The other is to use a library called [kittens](https://github.com/typelevel/kittens) that helps Cats. The code looks like this.
