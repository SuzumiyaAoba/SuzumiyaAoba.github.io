...
<Img src="./images/lm-studio_launch.png" alt="LM Studio 起動直後の画面。左側に検索アイコンが並んでいる" />
...
<Img src="./images/lm-studio_donwload-model.png" alt="plamo translate の検索結果一覧とダウンロードボタン" />
...
<Img src="./images/lm-studio_model-list.png" alt="ダウンロード済みモデルの一覧画面。plamo-2-translate 行のアクション列に歯車アイコンがある" />
...
<Img src="./images/lm-studio_model-template.png" alt="モデルのデフォルトパラメータ編集画面。Prompt タブが選択されている" />
...
<Img src="./images/lm-studio_termination.png" alt="停止文字列に <|plamo:op|> を設定し Enter を押した後のタグ表示" />
...
<Img src="./images/lm-studio_load-model.png" alt="ダウンロード済みモデルの選択メニュー。Plamo 2 Translate を選択する" />

次にいくつかの設定を求められるが、ここではデフォルトのまま「モデルを読み込む」をクリックする。

<Img src="./images/lm-studio_model-configuration.png" alt="モデル読み込み時の設定画面。デフォルト設定のまま読み込む" />
...
<Img src="./images/lm-studio_translate.png" alt="PLaMo 翻訳による英語から日本語への翻訳結果" />

<Img src="./images/google-translate.png" alt="同じ英文を Google 翻訳で翻訳した結果" />
...
<Img src="./images/lm-studio_plamo_response.png" alt="翻訳に対する指示を与えても反映されない応答例" />
