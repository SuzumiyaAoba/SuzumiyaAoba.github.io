...
<Img src="./images/lm-studio_launch.png" alt="LM Studio right after launch, with the search icon on the left side" />
...
<Img src="./images/lm-studio_donwload-model.png" alt="Search results for plamo translate with the download button" />
...
<Img src="./images/lm-studio_model-list.png" alt="List of downloaded models with the gear icon in the Action column for plamo-2-translate" />
...
<Img src="./images/lm-studio_model-template.png" alt="Default parameter editing screen with the Prompt tab selected" />
...
<Img src="./images/lm-studio_termination.png" alt="Tag display shown after setting the stop string to <|plamo:op|> and pressing Enter" />
...
<Img src="./images/lm-studio_load-model.png" alt="Downloaded model selection menu with Plamo 2 Translate" />

You will be prompted with some settings; leave them as default and click "Load Model".

<Img src="./images/lm-studio_model-configuration.png" alt="Model loading settings screen with default values" />

You will see a familiar ChatGPT-like UI. Enter English and press Enter.
PLaMo Translation returns the Japanese translation.
In the screenshots, I used a [description](https://etc.usf.edu/lit2go/41/the-merchant-of-venice/) of Shakespeare's _The Merchant of Venice_.

<Img src="./images/lm-studio_translate.png" alt="Japanese translation result produced by PLaMo Translation" />

<Img src="./images/google-translate.png" alt="The same English text translated by Google Translate" />
...
<Img src="./images/lm-studio_plamo_response.png" alt="Example response showing translation instructions being ignored" />
...
<Img src="./images/lm-studio_eject.png" alt="Location of the button to eject the model" />
