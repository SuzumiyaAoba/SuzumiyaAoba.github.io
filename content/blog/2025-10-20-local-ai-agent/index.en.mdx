...
This article is a supplement to [Do Local AI Agents Dream of Electric Sheep? (Environment Setup)](../2025-10-20-local-ai-agent/) covering what I couldn't in the previous post. Last time I installed [Ollama](https://ollama.com/) and [LM Studio](https://lmstudio.ai/), then ran the [mastra](https://mastra.ai/) sample code using the API server created by LM Studio.
...
<Img
  ...
  alt="mastra chat UI showing a response from the ollama model"
  width={800}
/>
