...
<Message title="Note" variant="warning" defaultOpen>
  This article does **not** give a rigorous explanation of type theory.
  The goal is to connect intuition with minimal theory, so you can say, "Ah, so that's a possible interpretation."
</Message>
