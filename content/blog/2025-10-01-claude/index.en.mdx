...
It does not show usage in real time like [calude-code-monoitor](https://github.com/Maciek-roboblog/Claude-Code-Usage-Monitor), so you must run `/usage` when you want to check.
...
When enabled, it shows "Thinking on". Press <kbd>Tab</kbd> again to disable.
...
For more details, see the [official announcement](https://www.anthropic.com/news/claude-sonnet-4-5) and the [Zenn article](https://zenn.dev/schroneko/articles/claude-sonnet-4-5).
