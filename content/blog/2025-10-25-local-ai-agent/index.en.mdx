...
Here we quote and follow the definition from [Practical Introduction to AI Agents for Real‑World Use (KS Information Science)](affiliate://ai-agent-practical-introduction).
