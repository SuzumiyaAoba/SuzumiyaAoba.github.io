...
<Img src="./images/lm-studio.png" alt="LM Studio GUI right after launch" width={800} />

Click the magnifying-glass icon at the bottom-left to search and download models.

<Img src="./images/lm-studio_search-gpt-oss-20b.png" alt="Search results for gpt-oss 20B with the download button" width={800} />
...
<Img src="./images/lm-sutdio_development.png" alt="Developer screen for starting a local server" width={800} />

Click "Select a model" and choose "OpenAI's gpt-oss 20B".

<Img src="./images/lm-studio_select-model.png" alt="Downloaded model selection screen with OpenAI's gpt-oss 20B" width={800} />

Loading a model consumes memory even before inference, as shown below.

<Img src="./images/lm-studio_model-load-memory-usage.png" alt="Memory usage while the model is loading" width={800} />

After loading, click the top-left icon to open the chat UI and try a prompt.

<Img src="./images/lm-studio_chat.png" alt="Testing the model in the LM Studio chat UI" width={800} />
...
<Img src="./images/lm-studio_model-eject.png" alt="Location of the Eject button for the loaded model" width={800} />
...
<Img src="./images/mastra_setup.png" alt="Setup questions shown when running npm create mastra" />
...
<Img src="./images/lm-studio_model-id.png" alt="Model ID shown in the LM Studio GUI" width={800} />
...
<Img src="./images/mastra_top.png" alt="Playground top page after starting the mastra dev server" width={800} />
...
<Img src="./images/mastra_weather.png" alt="Weather information returned by the Weather Agent" width={800} />
