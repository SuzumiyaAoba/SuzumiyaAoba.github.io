...
<Img src="./images/lm-studio_models.png" alt="LLM 一覧から設定変更タブを開く歯車ボタンの位置" />

「Custom Fields」を選択すると「Reasoning Effort」があるはずなのでプルダウンで Low から Midium に切り替える。

<Img src="./images/gpt-oss_change-reasoning-effort.png" alt="Reasoning Effort を Low から Medium に切り替えるプルダウン" />
