...
description: M4 Pro 搭載 Mac mini への買い替えを機に Ollama でローカル LLM を導入した手順と使ってみた感想をまとめる。
---
...
[Llama-3-ELYZA-JP-8B-GGUF](https://huggingface.co/elyza/Llama-3-ELYZA-JP-8B-GGUF) を試してみたが日本語 LLM は会話として成り立たないことがあるように感じた。これから発展していく分野だと思うので定期的に新しいモデルを探索していくつもりだ。
