...
model: GPT-5.2-Codex
description: Reimplementing the Reader monad sample from "All About Monads" in Scala using Cats.
---

This time I looked at the Reader monad and implemented the sample from the Reader monad page of [All About Monads](https://www.sampou.org/haskell/a-a-monads/html/index.html) using [Cats](https://typelevel.org/cats/). I just started using Cats so there may be a better way to write it, but it works for now, so I’ll just post the code.
