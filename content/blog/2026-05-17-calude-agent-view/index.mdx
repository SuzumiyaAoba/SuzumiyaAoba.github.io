...
Claude Code をいくつも起動してタスクをやらせていると (tmux や Zellij の) どのパネルで実行していたかわからなくなる。
...
しかし、課題として私の場合は Zellij で画面を分割して Claude Code に作業させるパネルと、
その結果を確認したり、何かしらコマンドを打つためのパネルに分割していることが多い。
